...
public class HelloWorldSpeechlet implements SpeechletV2 {
    ...
    public static String getMenu() throws IOException {
        Document doc = Jsoup.connect("http://nutrition.sa.ucsc.edu/menuSamp.asp?locationNum=40&locationName=College+Nine+%26+Ten&sName=&naFlag=").get();
        Elements menuItems = doc.select(".menusamprecipes");
        String menu = "";
    ...
    private SpeechletResponse getHelloResponse() {
        String speechText = "The menu for today is ";
        String menu = "";
        try{
            menu = getMenu();
        }catch(IOException e){
